...
const MiniMonitor: FC<MiniMonitorProps> = ({
  ...
  return (
      <div
          className={clsx(
              "relative row-span-1 h-full w-full max-w-sm cursor-pointer rounded-md border-2 border-neutral-400 bg-neutral-400 py-2 px-3 shadow-md transition-colors ",
              className,
              activeMonitorIds.includes(patientId) &&
                  "border-primary-200 shadow-neutral-200/25"
          )}
          onClick={() => {
      ...
      >
          <div className="mb-1 flex items-center gap-x-10">
              ...
              <button
                  ...
                  className="group absolute top-1.5 right-1.5 flex items-center justify-center rounded-md p-0.5 transition-all hover:bg-danger-700 hover:shadow-inner hover:shadow-danger-500/25"
              >
