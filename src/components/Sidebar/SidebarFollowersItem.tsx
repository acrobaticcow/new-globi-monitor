...
const SidebarFollowersItem: FC<SidebarFollowersItemProps> = ({
    ...
    return (
        <li
            ...
            id={id}
            className={clsx(
                "flex w-full cursor-pointer items-center gap-x-4 border-y border-transparent px-3 py-3 shadow-transparent ring-transparent transition-colors duration-200 ease-in-out shadow ring-1 hover:bg-neutral-200/10 active:ring-neutral-300",
