...
const SideBar: FC<SideBarProps> = ({ onChange }) => {
    ...
    return (
        <nav className="fixed top-0 left-0 z-50 flex h-screen max-h-screen w-14 flex-col border-r border-neutral-300 bg-neutral-500 pb-4 shadow-neutral-400 shadow-lg">
            <div className="mx-2 py-2">
                <img
                    className="aspect-square w-full rounded-full bg-neutral-100 object-cover object-center ring-neutral-200 ring-1"
                ...
                >
                    ...
                    >
                        <div className="flex w-full justify-center p-2">
                            <img
                                className="aspect-square w-8 rounded-full bg-neutral-100 object-cover object-center ring-neutral-200 ring-1"
                                src="/img/1.globi-logo.png"
                                alt=""
                            />
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute inset-0 z-0 h-full w-full rounded-3xl ring-neutral-200 peer-focus:ring-slate-600 peer-focus:ring"></div>
                        </div>
                        <SidebarFollowersList
                            className="h-full overflow-y-auto border-t-2 border-gray-700 py-4 shadow-gray-900 shadow-inner"
                            onChange={onChange}
                        />
                    </SidebarTrigger>
                </div>
